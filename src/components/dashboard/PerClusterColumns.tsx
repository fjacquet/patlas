 ...
 * metrics + a drill link. Presentational prop-consumer (no memo hooks, no
 * engine/store imports — `useEstateView` output is passed down by
 * `GlobalDashboard`). Section keeps the `<h2>Clusters</h2>` title.
 */
export function PerClusterColumns({ clusters, onSelectCluster }: PerClusterColumnsProps) {
